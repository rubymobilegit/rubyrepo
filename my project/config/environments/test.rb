MuddleMe::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => "muddleme.test.tst"}
  ...
  config.after_initialize do
    ActiveMerchant::Billing::Base.mode = :test
      ...
      ::PAYPAL_STANDARD_GATEWAY = ActiveMerchant::Billing::BogusGateway.new
      ::TEST_EXPRESS_GATEWAY = ActiveMerchant::Billing::BogusGateway.new
