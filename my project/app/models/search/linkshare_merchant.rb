class Search::LinkshareMerchant < Search::Merchant
  has_one :commission, :class_name => 'LinkshareCommission'
  belongs_to :advertiser, :class_name => 'LinkshareAdvertiser', :foreign_key => 'db_id'
