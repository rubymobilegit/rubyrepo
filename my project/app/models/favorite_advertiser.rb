class FavoriteAdvertiser < ActiveRecord::Base
  ...
  validates_uniqueness_of :cj_advertiser_id, :scope => :user_id, :message => 'This merchant has already been selected.'
  validates_uniqueness_of :avant_advertiser_id, :scope => :user_id, :message => 'This merchant has already been selected.'
  validates_uniqueness_of :linkshare_advertiser_id, :scope => :user_id, :message => 'This merchant has already been selected.'
  validates_uniqueness_of :pj_advertiser_id, :scope => :user_id, :message => 'This merchant has already been selected.'
  validates_uniqueness_of :ir_advertiser_id, :scope => :user_id, :message => 'This merchant has already been selected.'
