class PjAdvertiser < ActiveRecord::Base
  ...
  has_many :coupons, :class_name=>'PjCoupon', :foreign_key=>'advertiser_id', :primary_key=>'advertiser_id', :dependent=>:restrict
    ...
    begin
      ...
      self.transaction do
        advertisers.each do |row|
          ...
          advertiser ||= self.find_or_initialize_by_advertiser_id row['id']
