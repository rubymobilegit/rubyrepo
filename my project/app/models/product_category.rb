class ProductCategory < ActiveRecord::Base
  ...
  has_many :avant_preferred_advertisers, :source=>:avant_advertiser,
           :through=>:avant_advertiser_category_mappings,
           :conditions=>{:"avant_advertiser_category_mappings.preferred"=>true, :inactive => [false, nil]}
  has_many :avant_non_preferred_advertisers, :source=>:avant_advertiser,
           :through=>:avant_advertiser_category_mappings,
           :conditions=>{:"avant_advertiser_category_mappings.preferred"=>[false,nil], :inactive => [false, nil]}
  has_many :cj_advertiser_category_mappings
  has_many :cj_advertisers, :through=>:cj_advertiser_category_mappings
  has_many :cj_preferred_advertisers, :source=>:cj_advertiser,
           :through=>:cj_advertiser_category_mappings,
           :conditions=>{:"cj_advertiser_category_mappings.preferred"=>true, :inactive => [false, nil]}
  has_many :cj_non_preferred_advertisers, :source=>:cj_advertiser,
           :through=>:cj_advertiser_category_mappings,
           :conditions=>{:"cj_advertiser_category_mappings.preferred"=>[false,nil], :inactive => [false, nil]}
  ...
  has_many :linkshare_preferred_advertisers, :source=>:linkshare_advertiser,
           :through=>:linkshare_advertiser_category_mappings,
           :conditions=>{:"linkshare_advertiser_category_mappings.preferred"=>true, :inactive => [false, nil]}
  has_many :linkshare_non_preferred_advertisers, :source=>:linkshare_advertiser,
           :through=>:linkshare_advertiser_category_mappings,
           :conditions=>{:"linkshare_advertiser_category_mappings.preferred"=>[false,nil], :inactive => [false, nil]}

  has_many :pj_advertiser_category_mappings
  has_many :pj_advertisers, :through=>:pj_advertiser_category_mappings
  has_many :pj_preferred_advertisers, :source=>:pj_advertiser,
           :through=>:pj_advertiser_category_mappings,
           :conditions=>{:"pj_advertiser_category_mappings.preferred"=>true, :inactive => [false, nil]}
  has_many :pj_non_preferred_advertisers, :source=>:pj_advertiser,
           :through=>:pj_advertiser_category_mappings,
           :conditions=>{:"pj_advertiser_category_mappings.preferred"=>[false,nil], :inactive => [false, nil]}

  has_many :ir_advertiser_category_mappings
  has_many :ir_advertisers, :through=>:ir_advertiser_category_mappings
  has_many :ir_preferred_advertisers, :source=>:ir_advertiser,
           :through=>:ir_advertiser_category_mappings,
           :conditions=>{:"ir_advertiser_category_mappings.preferred"=>true, :inactive => [false, nil]}
  has_many :ir_non_preferred_advertisers, :source=>:ir_advertiser,
           :through=>:ir_advertiser_category_mappings,
           :conditions=>{:"ir_advertiser_category_mappings.preferred"=>[false,nil], :inactive => [false, nil]}
