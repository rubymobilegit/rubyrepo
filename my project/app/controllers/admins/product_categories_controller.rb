class Admins::ProductCategoriesController < ApplicationController
  ...
  def update
    ...
    if @product_category.update_attributes(params[:product_category])
      redirect_to admins_product_categories_path, :notice => 'Store category was successfully updated.' 
