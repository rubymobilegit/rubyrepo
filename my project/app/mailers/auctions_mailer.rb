class AuctionsMailer < ActionMailer::Base
  ...
  def auction_initiated_user auction
    ...
    mail :to => @user.email, :subject=> "MuddleMe auction initiated."
  end
  ...
  def auction_ended_user auction
    ...
    mail :to => @user.email, :subject=> "MuddleMe auction ended."
  end
  ...
  def auction_won_user auction
    ...
    mail :to => @user.email, :subject=> "MuddleMe auction ended. You have offers for #{@auction.name}"
  end
  ...
  def auction_won_vendor auction, vendor
    ...
    mail :to => @vendor.email, :subject=> "MuddleMe - you have won an search! Contact your lead today."
  end
  ...
  def first_confirmation_reminder auction
    ...
    mail :to => @user.email, :subject=> "Your MuddleMe auction for #{@auction.name} ended #{days} days ago. Provide feedback to claim your earnings!"
  end
  ...
  def vendor_confirm_outcome auction, vendor
    ...
    mail :to => @vendor.email, :subject=> "MuddleMe - confirm auction outcome for #{@auction.name}."
  end
  ...
  def low_funds_notification vendor, campaign = nil
    ...
    mail :to => @vendor.email, :subject=> "MuddleMe - #{subject_line}"
  end
  ...
  def recommended_auctions vendor, auctions
    ...
    mail :to => @vendor.email, :subject=> "MuddleMe - todays recommended auctions"
  end
